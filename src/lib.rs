...
#[derive(Debug)]
pub struct ForgeYarnProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ForgeYarnProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ForgeYarn processing");
    
    let mut processor = ForgeYarnProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ForgeYarnProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ForgeYarnProcessor::new(false);
